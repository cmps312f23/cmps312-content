...
fun ShoppingListScreen(onAddItem: () -> Unit, onEditItem: () -> Unit) {
    ...
    */
    ...
    val shoppingList = viewModel.shoppingListFlow.collectAsStateWithLifecycle(initialValue = emptyList()).value
    val shoppingItemsCount = viewModel.shoppingItemsCountFlow.collectAsStateWithLifecycle(initialValue = 0L).value
    ...
    Scaffold(
        topBar = {
            TopAppBar(title = {
                    Text(
                        text = "Shopping List (${shoppingItemsCount})",
