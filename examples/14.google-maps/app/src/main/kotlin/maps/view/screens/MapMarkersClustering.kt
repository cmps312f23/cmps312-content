...
val hamadAirportPosition = LatLng(25.260, 51.6138)
val islamicMuseumPosition = LatLng(25.295535181463016, 51.53918266296387)
val hamadStadiumPosition = LatLng(25.2511339955, 51.5345478618)
...
fun MapMarkersClustering() {
    ...
    LaunchedEffect(Unit) {
        ...
        items.add(MapClusterItem(LatLng(25.420738, 51.490154), "Lusail Stadium"))
