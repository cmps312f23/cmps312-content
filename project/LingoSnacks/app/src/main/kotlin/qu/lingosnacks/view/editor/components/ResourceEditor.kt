...
fun ResourceEditor(
    ...
    val resourceTypes = listOf(ResourceTypeEnum.Photo.toString(),
    ...
    fun isFormReady() = title.isNotBlank() && url.isNotBlank()
    ...
    Dialog(
        ...
        Column(
            ...
            Card(
                ...
                Dropdown(label = "Type", options = resourceTypes, selectedOption = type,
                    ...
                    Button(
                        onClick = {
                            Toast.makeText(
                                ...
                                .show()
                            onConfirm(Resource(url.trim(), title.trim(), type))
                        },
                        enabled = isFormReady(),
