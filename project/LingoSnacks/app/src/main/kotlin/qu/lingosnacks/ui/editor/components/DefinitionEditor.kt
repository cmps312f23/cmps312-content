...
fun DefinitionEditor(
    ...
    onConfirmClicked: (Definition) -> Unit
) {
    ...
    fun isUnique() = PackagesRepository.isUniqueDefinition(
        text,
        definitions.filterNot { it.text == definition.text })

    fun requiredFilled() = text.isNotBlank() && source.isNotBlank() && isUnique()
                    ...
                    Button(
                        onClick = {
                            Toast.makeText(
                                ...
                                .show()
                            onConfirmClicked(Definition(text.trim(), source.trim()))
                        },
